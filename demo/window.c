...
static void init(void) {
  ...
  _quad = gl4dgGenQuadf();
  initText(&_textTexId,
	   "Shrek ! est un livre écrit et illustré par William Steig. L'ouvrage paraît en 1990 "
	   "et raconte l'histoire d'un jeune ogre qui a trouvé l'ogresse de ses rêves, après avoir "
	   "quitté sa maison pour découvrir le monde . La saga cinématographique Shrek s'est basée "
	   "sur le livre une décennie après sa publication.");
}
